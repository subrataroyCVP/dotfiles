...
function main() {
  ...
  clone_repository "https://github.com/subrataroyCVP/dotfiles.git" "${dotfiles_dir}"
  ...
  clone_repository "https://github.com/romkatv/powerlevel10k.git" "${HOME}/.oh-my-zsh/themes/powerlevel10k"
